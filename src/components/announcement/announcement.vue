<template>
    ...
    <div class="inform_page">
        <!-- 顶部搜索栏 -->
        <div class="topsearch_container" style="">
            <div class="top_title">
                <a href="./index.html"><i class="icon-chevron-left"></i>返回</a>
                <div>通知公告</div>
            </div>
...
.inform_page .topsearch_container .select {
